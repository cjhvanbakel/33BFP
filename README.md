## README
This File contains MATLAB R2023b scripts used for my bachelor project on fiber splicing.<br>
...
The Loss_vs_gap.m file contaisn code to create the main figure in the results section.<br>
