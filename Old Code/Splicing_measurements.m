...
%% Splicing parameters
manualPart = get_manual_input(); % Get a pop-up to fill in the manual parameters after the splice.
if isempty(manualPart), error('Data entry cancelled.'); % Raise error when not filled in correctly
end 
